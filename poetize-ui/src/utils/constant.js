export default {
  ...
  // baseURL: "https://maoye.vip/api",
  // imBaseURL: "https://maoye.vip/im",
  // webURL: "https://maoye.vip",
  // baseURL: "https://poetize.cn/api",
  // imBaseURL: "https://poetize.cn/im",
  // webURL: "https://poetize.cn",

  live2d_path: "https://qiniu.maoye.vip/live2d-widget/",
  ...
  random_image: "https://qiniu.maoye.vip/ArticleFengMian/4kfengmian%205.jpg?",
  //前后端定义的密钥，AES使用16位
  cryptojs_key: "qingjiaowoyaomei",
  qiniuUrl: "https://upload-z2.qiniup.com",
  // qiniuDownload: "http://rrk78lumu.hn-bkt.clouddn.com/",
  qiniuDownload: "https://qiniu.maoye.vip/",


  friendWebName: "云朵☁️",
  // friendUrl: "https://maoye.vip/",
  friendUrl: "https://yunduo.me/",
  friendAvatar: "http://qiniu.maoye.vip/webAvatar/maoye11681531745536443.jpg",
  friendIntroduction: "🥬我一个捡瓶子的,我哪里会什么前端🥬",
  friendCover: "https://qiniu.maoye.vip/fengmian/zh_biying2.png",

  favoriteVideo: "http://127.0.0.1:8081/video/video1.mp4",
  ...
  loveLike: "http://qiniu.maoye.vip/aixin/xindong.gif", //爱心
  loveSortId: 1,
  loveLabelId: 1,
